...
#Please remember that, when using NOISeq, the probability of dierential expression is not equivalent to 1 − pvalue. We recommend for q to use values around 0.8
