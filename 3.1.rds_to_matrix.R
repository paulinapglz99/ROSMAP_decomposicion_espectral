...
mi_list <- readRDS('/datos/rosmap/coexpre_matrix/ROSMAP_RNAseq_MutualInfo_noAD_NIA_Reagan_dicho_zero.rds')
...
saveRDS(coexpre_mat_unnested, file = '/datos/rosmap/coexpre_matrix/ROSMAP_RNAseq_MutualInfo_noAD_NIA_Reagan_dicho_zero.rds')
